...
```html
<a href="http://localhost:8080/other" ping="http://localhost:8080/log">
  Go to Other Page
</a>
```

上面示例中，用户点击链接时，除了发生跳转，还会向`http://localhost:8080/log`发送一个 POST 请求。服务端收到这个请求以后，就会知道用户点击了这个链接。
...
<!-- 联系方式 -->
<link rel="me" href="https://google.com/" type="text/html">
<link rel="me" href="mailto:name@qwer.com">
<link rel="me" href="sms:+110">
